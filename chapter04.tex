...
\begin{definition}
  ...
  \begin{mathpar}
    ...
    \mpair M N \and \textrm{let}_O \: \mpair x y = M \: \textrm{in} \: N \and
      (x \is\pi M) \otimes N \\
    \textrm{let}_O \: \munit \: \textrm{=} \: M \: \textrm{in} \: N \\
...
\begin{mathpar}
  ...
  {
    \Gamma_1 + \Gamma_2 \vdash \textrm{let}_O \: \mpair x y \: \textrm{=}
...
\begin{mathpar}
  ...
  {
    \Gamma_1 + \Gamma_2 \vdash \textrm{let}_O \: \munit \: \textrm{=}
