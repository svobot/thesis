...
\begin{mathpar}
  ...
  {
    \Gamma_1, \Gamma_2 \vdash \letp {x \is{} S} {y \is{} T} M N \is{} U
  }
...
Consider that instead of the~\emph{let} pair eliminator in
...
replace the~original \ir{$\times$-I} and \ir{$\times$-E}:
\begin{mathpar}
  \inferrule*[right=$\times$-I$'$]
...
Terms can be expressed using the~alternative forms:
\[
  \letu M N := N
\]
...
\begin{definition}
  ...
  \begin{mathpar}
    ...
    \mpair M N \and \letp {x \is{} S} {y \is{} T} M N \\
    \apair M N \and \fst M \and \snd M \\
    \letu M N \and \oc M \and \letoc x M N
  \end{mathpar}
\end{definition}
...
\begin{mathpar}
  ...
  }
  {
    ...
    \vdash \letp {x \is{} S} {y \is{} T} M N \is{} U
  }
\end{mathpar}
